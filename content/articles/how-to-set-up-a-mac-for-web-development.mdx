...
featuredImage: /images/how-to-set-up-a-mac-for-web-development/clement-h-544786-unsplash.jpg
...
<Figure
  caption="Photo by Clément H."
  alt="A MacBook with code on its screen sitting on a white desk with a green plant in the far right corner."
  src={`/images/how-to-set-up-a-mac-for-web-development/clement-h-544786-unsplash.jpg`}
  width={2400}
  height={1500}
  priority
/>
...
The easiest way to show your Mac’s hidden files is with the keyboard shortcut `cmd-shift-.`. This will alternate between showing and hiding these files so you can access them when you need them.
