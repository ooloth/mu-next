...
type: 📺
featuredImage: /images/up-and-running-with-gatsby/gatsby-10-using-graphql-with-gatsby.png
...
Check out [Using GraphQL with Gatsby](https://youtu.be/IaorT4-efuU) or [view the entire playlist](https://www.youtube.com/watch?v=jAa1wh5ATm0&list=PLHBEcHVSROXQQhXpNhmiVKKcw72Cc0V-U) on YouTube.
